...
def test_create_default_company_values():
    ...
    assert values["corporation_name"] == "Google"
    assert values["corporation"] == "Google"
    assert values["signing_entity_name"] == "Google"
    assert values["signatory_name"] == "Signatory1"
    assert values["signatory_email"] == "signatory@example.com"
    assert values["point_of_contact"] == "Manager1"
    assert values["cla_manager_name"] == "Manager1"
    assert values["email"] == "manager@example.com"
    assert values["cla_manager_email"] == "manager@example.com"
    assert values["scheduleA"] == "Schedule"
    ...
    assert values["corporation_name"] == "Google"
    assert values["corporation"] == "Google"
    assert values["signing_entity_name"] == "Google1"
    ...
    assert "signing_entity_name" not in values
